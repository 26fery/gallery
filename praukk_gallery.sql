...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Feb 2024 pada 04.00
...
(2, 'fery', 'gajelas', '2024-02-26', 1),
(3, 'fery.baru', 'baru', '2024-02-26', 1);
...
(1, 'impian', 'mobil baru', '2024-02-26', '797288163_1143935139_ini juga.jpg', 2, 1),
(2, 'haii', 'i am ', '2024-02-26', '95593360_1309100005_1752517422_friends.2.jpeg', 2, 1);
...
(1, 2, 1, 'ini anak anak R', '2024-02-27'),
(2, 2, 1, 'basiss', '2024-02-27'),
(3, 2, 1, 'anak anak R jelek banget', '2024-02-27'),
(4, 2, 1, 'dhgadg', '2024-02-27'),
(5, 2, 1, 'okkk', '2024-02-27'),
(6, 2, 1, 'hayuu', '2024-02-27'),
(7, 1, 1, 'mobil kuu', '2024-02-27');
...
CREATE TABLE `user` (
  ...
  `namalengkap` varchar(255) CHARACTER SET utf8 NOT NULL,
...
(1, 'admin', 'admin', 'hfery533@gmail.com', 'Fery Herdiansyah', 'jl. hd jangkrik');
